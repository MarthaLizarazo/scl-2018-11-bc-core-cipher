window.cipher = {
  ...
  for (let i= 0; i<mensaje.length; i++) {
   ...
   resultado += String.fromCharCode(letraAscci);
    ...
    if (letraAscci>=97 && letraAscci<=122) { // condición código ASCII (Valores minúsculas)
    resultado += String.fromCharCode((letraAscii-97+offset)%26+97) //Obtener el nuevo código ASCII mediante fórmula
    }else{
